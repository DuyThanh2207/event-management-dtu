...
const ManageAccount = () => {
    ...
    dataUser.forEach((item) => {
        if (item.account_name.toLowerCase().indexOf(searchText.toLowerCase()) !== -1 || item.account_id.toLowerCase().indexOf(searchText.toLowerCase()) !== -1 || item.account_username.toLowerCase().indexOf(searchText.toLowerCase()) !== -1 || item.account_email.toLowerCase().indexOf(searchText.toLowerCase()) !== -1 || item.account_role.toLowerCase().indexOf(searchText.toLowerCase()) !== -1)
    ...
    const getEditUser = (user) => {
        axios.post('/edit-user', {
            account_id: user.id.toUpperCase(),
            account_name: user.name,
            account_username: user.username.toLowerCase(),
